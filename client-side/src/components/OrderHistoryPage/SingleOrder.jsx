  ...
  return (
    <Paper sx={styles.paper}>
      <Box sx={styles.userContainer}>
        ...
        <Typography><span style={styles.label}>Paid: </span>{order.billing.paid ? "Yes" : "No"}</Typography>
        <Typography><span style={styles.label}>Subtotal: </span>{formatCurrency(order.billing.subtotal)}</Typography>
        <Typography><span style={styles.label}>Tax: </span>{formatCurrency(order.billing.tax)}</Typography>
        <Typography><span style={styles.label}>Total: </span>{formatCurrency(order.billing.subtotal + order.billing.tax)}</Typography>
      </Box>
